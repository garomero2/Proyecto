...
<div class="bg-light py-3">
   <div class="container">
     <div class="row">
       ...
       <div class="col-md-12 mb-0"><a href="index.php">Inicio</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">VITAMINAS Y SUPLEMENTOS</strong></div>
     </div>
   </div>
</div>
...
<div align="right">
	...
	if($_GET){
        ...
        FROM tblvitaminas WHERE Nombre = :doc';
 ...
 <div class="row">
  ...
  <?php
   $sentencia= $pdo -> prepare("SELECT * FROM tblvitaminas");
   $sentencia->execute();
